...
# from BODF.Select_K.BoDeepForest.gc import *    #导入深度森林
from BODF.Select_K.BoDeepForest.Comparegc import *
...
# x_train, x_left, y_train, y_left = train_test_split(x, y, test_size=0.2)
